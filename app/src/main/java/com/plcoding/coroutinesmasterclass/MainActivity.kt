...
import com.plcoding.coroutinesmasterclass.birds.presentation.BirdScreen
import com.plcoding.coroutinesmasterclass.birds.presentation.BirdViewModel
...
class MainActivity : ComponentActivity() {
    private val viewModel by viewModels<BirdViewModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CoroutinesMasterclassTheme {
                BirdScreen(viewModel = viewModel)
            }
        }
    }
}